...
Write-Host "========================================="
Write-Host "  BitDrum V2 Manual Deployment (BOT Chain Mainnet)"
Write-Host "========================================="
...
Write-Host ">>> vault.deposit() with 5 BOT seed"
cast send $VAULT "deposit()" --value 5ether --rpc-url $RPC --private-key $PK  --legacy
