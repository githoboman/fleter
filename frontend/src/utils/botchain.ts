...
export const BOTCHAIN_MAINNET = {
  ...
  rpcUrls: ["https://api.infra.mainnet.botchain.network"],
...
export const BOTCHAIN_SHANNON = {
  ...
  rpcUrls: ["https://dream-rpc.botchain.network"],
  blockExplorerUrls: ["https://shannon-explorer.botchain.network"],
...
export const BOTCHAIN_EXPLORER_BASE_URL =
  ACTIVE_BOTCHAIN_NETWORK.blockExplorerUrls[0] || "https://shannon-explorer.botchain.network";
